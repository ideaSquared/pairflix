...
export const Container = styled.div<ContainerProps>`
  width: ${({ isFullWidth = true }) => (isFullWidth ? '100%' : 'auto')};
...
const MobileNavLink = styled(Typography)<{
  active?: boolean;
  onClick?: () => void;
}>`
...
const NavLink = styled(Typography)<{ active?: boolean; onClick?: () => void }>`
  color: ${({ active, theme }) =>
    active ? theme.colors.primary : theme.colors.text.primary};
  cursor: pointer;
...
const FooterLink = styled(Typography)<{ onClick?: () => void }>`
