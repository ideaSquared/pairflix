...
export const Interactive: Story = {
	render: () => {
		...
		return (
			<Container>
				<Description>
					Type to see the debounced value update. Press Enter or click the
					Search button to trigger a search.
				</Description>
				...
				<ResultsContainer>
					<div>
						<strong>Current value (debounced):</strong>{' '}
						{searchTerm || '(empty)'}
					</div>
					<div>
	...
	render: () => {
		...
		return (
			<Container>
				...
				<Description>
					The SearchBar can show a clear button when text is entered. This can
