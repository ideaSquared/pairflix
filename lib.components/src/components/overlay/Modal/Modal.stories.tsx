	...
	render: () => {
		...
		return (
			<Container>
				...
				<SectionDescription>
					The Modal component allows custom header rendering for complete
					control over the header appearance and functionality.
				</SectionDescription>
				...
				<Card>
					...
					>
						<div style={{ padding: '16px' }}>
							...
							<p>
								Custom headers are useful when you need to add additional
								controls or styling to the modal header.
							</p>
						</div>
					</Modal>
				</Card>
			...
			<Container>
				...
				<Card>
					...
					>
						<div style={{ padding: '16px' }}>
							<p>
								This modal can only be closed using the close button in the
								header or the button below. Clicking outside the modal or
		...
		return (
			<Container>
				...
				<SectionDescription>
					...
					accessibility and user experience. You can control where focus goes
				...
				<ul style={{ margin: '0 0 16px 0', paddingLeft: '20px' }}>
					<li>
						<strong>initialFocusRef</strong>: Element to receive focus when
						modal opens (input field above)
					</li>
					<li>
					...
					<li>
						Without these props, focus defaults to the first focusable element
						in the modal
					</li>
					<li>
						Focus is trapped inside the modal while open for better
						accessibility
					</li>
				</ul>
	...
	render: () => {
		...
		return (
			<Container>
				...
				<SectionDescription>
					The Modal component fully supports dark theme through the
					ThemeProvider from styled-components. All colors, borders, and shadows
				...
				<Card>
					...
					>
						<div style={{ padding: '16px' }}>
							...
							<p>
								All styled components in the modal automatically adapt to the
								dark theme, maintaining proper contrast and visual hierarchy.
							</p>
						</div>
					</Modal>
				</Card>
	...
	render: () => {
		...
		return (
			<Container>
				...
				<SectionDescription>
					The Modal component is built with accessibility in mind, following
					WCAG guidelines and best practices for modal dialogs.
				</SectionDescription>
