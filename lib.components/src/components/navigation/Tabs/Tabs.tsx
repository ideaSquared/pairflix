...
export const Tabs = forwardRef<HTMLDivElement, TabsProps>(
	(
		...
		const registerTab = (id: string, disabled = false) => {
		...
		const contextValue = useMemo(
			...
			[controlledValue, selectedTab, vertical]
		);
