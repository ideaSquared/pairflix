...
import * as styles from './UserActivityContent.css';
...
const UserActivityContent: React.FC = () => {
  ...
  return (
    <>
      ...
      {stats && (
        <>
          <H3 className={styles.sectionHeader}>Most Common Activities</H3>
      ...
      {/* Filters */}
      <H3 className={styles.sectionHeader}>User Activity History</H3>
      <FilterGroup
      ...
      {/* Activities Table */}
      <Card className={styles.activityTable}>
                ...
                {isLoading ? (
                  ...
                  activities.map(activity => {
                    ...
                    return (
                      <tr
                        key={activity.id}
                        className={styles.tableRow({ isToday })}
                      >
                        <TableCell>
