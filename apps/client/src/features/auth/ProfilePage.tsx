...
const PreferencesCard = ({ children }: { children: React.ReactNode }) => (
  <Card variant="secondary" className={styles.preferencesCard}>
    {children}
  </Card>
);

const Label = ({ className, ...rest }: TypographyProps) => (
  <Typography
...
const Value = ({ className, ...rest }: TypographyProps) => (
  <Typography
    className={`${styles.value}${className ? ` ${className}` : ''}`}
    {...rest}
  />
);

const ErrorMessage = ({ className, ...rest }: TypographyProps) => (
  <Typography
    className={`${styles.errorMessage}${className ? ` ${className}` : ''}`}
    {...rest}
  />
);

const SuccessMessage = ({ className, ...rest }: TypographyProps) => (
  <Typography
    className={`${styles.successMessage}${className ? ` ${className}` : ''}`}
    {...rest}
  />
);
  ...
  return (
    <PageContainer maxWidth="md" padding="lg" centered>
      ...
      <div className={styles.profileContainer}>
        ...
        <form className={styles.styledForm} onSubmit={handleUsernameUpdate}>
          <FormCard>
            <CardContent>
        ...
        <form className={styles.styledForm} onSubmit={handleEmailUpdate}>
          <FormCard>
            <CardContent>
        ...
        <form className={styles.styledForm} onSubmit={handlePasswordUpdate}>
          <FormCard>
            <CardContent>
