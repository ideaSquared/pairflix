 ...
 */
async function handleFailedLogin(user: User, ip: string): Promise<void> {
...
export const resetPassword = async (
	...
	// Sequelize's `include` attaches the eager-loaded association at runtime,
	// but it isn't part of PasswordReset's declared attribute types.
	const user = (resetRequest as PasswordReset & { user: User }).user;
