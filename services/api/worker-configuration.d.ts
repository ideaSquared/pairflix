/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c99a232d2d8253bdc9638cd4d2bbfb58)
// Runtime types generated with workerd@1.20260811.1 2026-08-01 
interface __BaseEnv_Env {
	DB: D1Database;
	ENVIRONMENT: "staging" | "production";
	ALLOWED_ORIGINS: "https://staging.your-staging-domain.example" | "https://your-production-domain.com";
	BILLING_MOCK_ENABLED: "true" | "false";
}
...
interface CryptoKeyHmacKeyAlgorithm {
    name: string;
    hash: deadbeefCryptoKeyKeyAlgorithm;
    length: number;
}
...
interface URLPatternResult {
    ...
    hash: deadbeefURLPatternComponentResult;
}
