...
import * as storyStyles from './Textarea.stories.css';
...
const FormGroup = ({ children }: { children: ReactNode }) => (
  <div className={storyStyles.formGroup}>{children}</div>
);
...
const StatusDisplay = ({ children }: { children: ReactNode }) => (
  <div className={storyStyles.statusDisplay}>{children}</div>
);
