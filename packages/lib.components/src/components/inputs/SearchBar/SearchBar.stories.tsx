...
import * as storyStyles from './SearchBar.stories.css';
...
const ResultsContainer = ({ children }: { children: ReactNode }) => (
  <div className={storyStyles.resultsContainer}>{children}</div>
);

const Section = ({ children }: { children: ReactNode }) => (
  <div className={storyStyles.section}>{children}</div>
);

const SectionTitle = ({ children }: { children: ReactNode }) => (
  <h3 className={storyStyles.sectionTitle}>{children}</h3>
);

const Divider = () => <hr className={storyStyles.divider} />;

const Description = ({ children }: { children: ReactNode }) => (
  <p className={storyStyles.description}>{children}</p>
);

const Grid = ({ children }: { children: ReactNode }) => (
  <div className={storyStyles.grid}>{children}</div>
);
