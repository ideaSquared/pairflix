...
// Component wrapper for checkbox demo
...
// Component wrapper for context menu demo
...
// Component wrapper for application menu demo
const ApplicationMenuDemo: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', gap: '0.5rem' }}>
      ...
      <DropdownMenu trigger={<Button variant="text">Tools</Button>}>
        <DropdownMenuItem icon={<SettingsIcon />}>Preferences</DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuSub>
