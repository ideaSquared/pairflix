...
// Presentational wrappers for better visual organization
const Container = ({
  className,
  ...props
...
const GroupRow = ({
  ...
  <div className={clsx(styles.groupRow, className)} {...props} />
);
...
const SectionTitle = ({
  ...
  <h3 className={clsx(styles.sectionTitle, className)} {...props}>
    {children}
  </h3>
);
...
const SectionDescription = ({
  ...
  <p className={clsx(styles.sectionDescription, className)} {...props} />
);
...
const ItemContainer = ({
  ...
  <div className={clsx(styles.itemContainer, className)} {...props} />
);
...
const ItemLabel = ({
  ...
  <div className={clsx(styles.itemLabel, className)} {...props} />
);
...
const CodeBlock = ({
  ...
  <pre className={clsx(styles.codeBlock, className)} {...props} />
);
      ...
      <Card>
        ...
        >
          <div style={{ padding: '16px' }}>
            <p>
              This modal&apos;s open state is controlled by the parent
              component.
            </p>
...
const CustomHeaderDemo: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <SectionTitle className={styles.subsectionTitleWithMarginTop}>
        Implementation
      </SectionTitle>
      <CodeBlock>{`
<Modal
...
const CloseBehaviorDemo: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <GroupRow>
        <div>
          <SectionTitle className={styles.subsectionTitle}>
  ...
  return (
    <Container>
      ...
      <SectionDescription>
        ...
        vanilla-extract theme class. All colors, borders, and shadows adapt
      ...
      <Card>
        ...
        >
          <div style={{ padding: '16px' }}>
            <p>This modal uses the dark theme class applied by an ancestor.</p>
            <p>
              All of the modal&apos;s styles automatically adapt to the dark
      ...
      <CodeBlock>{`
// Apply the dark theme class to an ancestor element
        ...
        <ItemContainer>
          ...
          <div>
            ...
            >
              <div style={{ padding: '16px' }}>
                <p style={{ marginTop: 0 }}>
                  Are you sure you want to delete &quot;The Matrix&quot; from
          ...
          <div style={{ padding: '16px' }}>
            {!formSubmitted ? (
              ...
              <div style={{ textAlign: 'center', padding: '24px 0' }}>
                ...
                <p style={{ color: '#666' }}>
                  &quot;{formData.title}&quot; has been added to your
                  collection.
                </p>
              </div>
            )}
