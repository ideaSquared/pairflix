...
import { Badge, type BadgeProps, StatusBadge } from './Badge';

const TestWrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className={`${lightThemeClass} ${themeRoot}`}>{children}</div>
);
...
describe('Badge Component', () => {
  describe('Basic Rendering', () => {
    ...
    it('applies custom className', () => {
      ...
      expect((container.firstChild as HTMLElement).firstChild).toHaveClass(
        'custom-badge'
      );
    });
