...
import * as storyStyles from './Pagination.stories.css';
...
export const Simple: Story = {
  render: () => (
    <SimplePagination currentPage={1} totalPages={10} onPageChange={() => {}} />
  ),
};
...
export const CustomizedPagination: Story = {
  render: () => (
    <Pagination
      ...
      showPageNumbers
      showFirstLast
      className={`custom-pagination ${storyStyles.customized}`}
      onPageChange={() => {}}
    />
  ),
};
